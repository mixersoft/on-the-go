...
- (UIImage *)imageWithFixedOrientationSized:(CGSize)size {
    
    if (self.imageOrientation == UIImageOrientationUp && self.size.width == size.width && self.size.height == size.height) return self;
